...
const urlAPI = "https://localhost:44318/categoriasdepartamento";
let dadosEmpresa = "";
...
const exibirDepartamentos = (u) => {
  Array.from(u).forEach((lista) => {
    dadosEmpresa += `
        <tr>
        <td class=""></td>
        <td class="IdDep">${lista.idCategoriaDepartamento}</td>
        <td class="IdEmp">${lista.idCategoria}</td>
        <td class="IdDep">${lista.idDepartamento}</td>
        <td class="NomeDep">${lista.nomeDepartamento}</td>
        <td class="NomeEmp" id="cnpjList">${lista.nomeCategoria}</td>
        <td>
